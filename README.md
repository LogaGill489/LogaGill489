...
<main>
  ...
  <div class="write-stats">&nbsp;
    ...
    🔹 I enjoy working on web developement projects, with over a year of <strong>web-dev</strong> experience using <strong>Javscript</strong> and <strong>React</strong>. <br><br>&nbsp;
