...
- ⚡ 2.5+ years of experience in **C-based languages**.

- 💡 4 months of **web-dev** experience.

- 🔭 Working on my personal website **(releasing soon)** using **JQuery**, **Javascript**, **HTML**, & **CSS**.
  
- 🌱 Currently learning **CSS** and **HTML** through project work.
